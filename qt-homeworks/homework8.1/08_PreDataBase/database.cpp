...
void DataBase::RequestToDB(QString request)
{
    if(request == "*") {
        ...
        tableModel->select();
        tableModel->setHeaderData(1, Qt::Horizontal, QObject::tr("Название фильма"));
        tableModel->setHeaderData(2, Qt::Horizontal, QObject::tr("Описание фильма"));
        emit sig_SendTableFromDB(tableModel);
    }
    else {
